...
return [
  ...
  DashboardController::class => new DashboardController(new CategoryService(new CategoryRepository($connection)), new ProductService(new ProductRepository($connection)), new CloudinaryService(), new AuthenticationService(new UserRepository($connection)), new ProviderService(new ProviderRepository($connection)), new BrandService(new BrandRepository($connection)), new BrandSizeService(new BrandRepository($connection), new BrandSizeRepository($connection), new SizeRepository($connection))),
  ProductAdminController::class => new ProductAdminController(new CategoryService(new CategoryRepository($connection)), new ProductService(new ProductRepository($connection)), new AuthenticationService(new UserRepository($connection))),
