        ...
        <>
            <div className="dark:bg-sidebar-background sticky top-0 right-0 left-0 z-50 border-b border-sidebar-border/80 bg-white">
                <div className="mx-auto flex h-16 items-center px-4 md:max-w-7xl">
                    ...
                    <Link href="/the-owl/public/" prefetch className="flex items-center space-x-2">
                        <AppLogo />
                    </Link>
                        ...
                        {auth.user ? (
                            ...
                            <Button variant="outline" className="flex items-center space-x-2">
                                <Link href={route('login')} className="flex items-center space-x-2">
                                    ...
                                    <LogIn className="size-5 overflow-hidden rounded-full" />
                                </Link>
                            </Button>
                        )}
                        {auth.user && auth.user.role.Nombre === 'administrador' ? (
                            <Button variant="outline" className="flex items-center space-x-2">
