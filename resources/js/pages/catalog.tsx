            ...
            <div className="border-b bg-white shadow-sm">
                <div className="mx-auto max-w-7xl px-4 py-6">
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                        <h1 className="mb-4 text-3xl font-bold text-gray-900 md:mb-0">Catálogo de Productos</h1>
                ...
                <div className="flex flex-col gap-8 lg:flex-row">
                        ...
                        <div className={`space-y-6 rounded-lg border bg-white p-6 shadow-sm ${showFilters || 'hidden lg:block'}`}>
                            ...
                            <div className='text-neutral-700'>
                                ...
                                >
                                    ...
                                    <SelectContent className='text-neutral-700 bg-white'>
                                        {categories.map((category) => (
                                            <SelectItem key={category.CategoriaId} value={category.Nombre}
                                            className='text-neutral-700 bg-white hover:bg-blue-500 hover:text-white'>
                                                {category.Nombre}
                                            </SelectItem>
                                        ))}
                                    </SelectContent>
                    ...
                    <div className="flex-1">
                        {filteredProducts.length === 0 ? (
                            ...
                            <div
                                className={viewMode === 'grid' ? 'grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4' : 'space-y-4'}
                            >
