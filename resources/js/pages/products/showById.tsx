                ...
                <div className="sticky top-0 z-10 border-b bg-white">
                    <div className="mx-auto max-w-7xl px-4 py-4">
                        <div className="flex items-center justify-between">
                            <Link href="/the-owl/public/catalog" className="flex items-center text-neutral-600 hover:text-neutral-900">
                            ...
                            <div className="flex items-center space-x-4">
                                ...
                                <button className="rounded-full p-2 text-neutral-400 hover:bg-neutral-100 hover:text-neutral-600">
                                    <Share2 size={20} />
                                </button>
                            </div>
                        </div>
                ...
                <div className="mx-auto max-w-7xl px-4 py-8">
                    <div className="grid grid-cols-1 gap-12 lg:grid-cols-2">
                        ...
                        <div className="space-y-6">
                            ...
                            {/* Descripción */}
                            <div>
                                <h3 className="mb-2 text-lg font-semibold text-neutral-900">Sobre esta bebida</h3>
                                <p className="leading-relaxed text-neutral-600">{product.Descripcion}</p>
                            </div>
                                    ...
                                    <div className="flex items-center space-x-4">
                                        ...
                                        <div className="flex items-center rounded-lg border border-neutral-300">
                                            <Button
                                                ...
                                                disabled={quantity <= 1}
                                                className="bg-white p-2 hover:bg-neutral-100 disabled:cursor-not-allowed disabled:opacity-50"
                                            >
                                                <Minus size={16} />
                                            </Button>
                            ...
                            <div className="space-y-3 rounded-lg bg-neutral-50 p-4">
                                <div className="flex items-center space-x-3">
                                    ...
                                    <span className="text-sm text-neutral-600">Entrega refrigerada disponible</span>
                                </div>
                                <div className="flex items-center space-x-3">
                                    <Shield className="text-green-600" size={20} />
                                    <span className="text-sm text-neutral-600">Productos 100% originales</span>
                                </div>
                                <div className="flex items-center space-x-3">
                                    <Thermometer className="text-orange-600" size={20} />
                                    <span className="text-sm text-neutral-600">Almacenamiento en condiciones óptimas</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="mt-12 grid grid-cols-1 gap-8 lg:grid-cols-2">
                        ...
                        <div className="rounded-lg border bg-white p-6">
                            <h3 className="mb-4 text-xl font-semibold text-neutral-900">Información del producto</h3>
                            <dl className="space-y-3">
                                {productDetails.map((detail, index) => (
                                    <div key={index} className="flex justify-between border-b border-neutral-100 py-2 last:border-b-0">
                                        <dt className="font-medium text-neutral-600">{detail.label}:</dt>
                        ...
                        <div className="rounded-lg border bg-white p-6">
                            <h3 className="mb-4 text-xl font-semibold text-neutral-900">Política de la bodega</h3>
                    ...
                    <div className="mt-8 rounded-lg bg-neutral-100 p-4">
                        <details>
                            <summary className="mb-2 cursor-pointer font-medium text-neutral-700">
                                Datos del producto (QUITAR PARA PRESENTACION)
                            </summary>
                            <pre className="overflow-auto text-xs text-neutral-600">{JSON.stringify(product, null, 2)}</pre>
                        </details>
                    </div>
                </div>
            </div>
