                ...
                <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                    ...
                    <div className="mb-8">
                        <div className="flex items-center justify-between">
                            <div>
                                <h1 className="text-3xl font-bold text-gray-900">Panel de Control - Marcas</h1>
                    ...
                    <div className="mb-6 rounded-lg bg-white shadow">
                        ...
                        <div className="p-6">
                            <div className="grid grid-cols-1 items-end gap-4 md:grid-cols-4">
                                <div>
                                    <Label className="mb-2 block text-sm font-medium text-gray-700">Buscar marca</Label>
                    ...
                    <div className="rounded-lg bg-white shadow">
                        <div className="border-b border-gray-200 px-6 py-4">
                            <div className="flex items-center justify-between">
                                <h3 className="text-lg font-medium text-gray-900">Inventario de Marcas ({filteredBrands.length})</h3>
                            ...
                            <table className="min-w-full divide-y divide-gray-200">
                                <thead className="bg-gray-50">
                                    <tr>
                                        ...
                                        <th className="px-6 py-3 text-left text-xs font-medium tracking-wider text-gray-500 uppercase">Marca</th>
                                ...
                                <tbody className="divide-y divide-gray-200 bg-white">
                                    {paginatedBrands.length === 0 ? (
                                        ...
                                        paginatedBrands.map((brand) => (
                                            <tr key={brand.MarcaId} className="hover:bg-gray-50">
                                                <td className="px-6 py-4 font-mono text-sm whitespace-nowrap text-gray-900">
                                                    #{String(brand.MarcaId).padStart(4, '0')}
                                                </td>
                                                <td className="px-6 py-4 text-sm whitespace-nowrap text-gray-900">{brand.Nombre}</td>
