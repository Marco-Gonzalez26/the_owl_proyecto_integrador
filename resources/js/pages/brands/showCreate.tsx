...
import { AlertTriangle, CheckCircle, LoaderCircle, Save, Star, X, XCircle } from 'lucide-react';
...
const breadcrumbs = [
    ...
    {
        title: 'Crear Marca',
        href: '/the-owl/public/dashboard/brands/create',
    },
];
                ...
                <div className="mx-auto max-w-3xl px-4 py-8 sm:px-6 lg:px-8">
                    ...
                    <div className="mb-8">
                        <div className="flex items-center justify-between">
                            <div>
                                <h1 className="text-3xl font-bold text-neutral-900">Crear Marca</h1>
                                <p className="mt-2 text-sm text-neutral-600">Crear una nueva marca para productos</p>
                            </div>
                            <Link
