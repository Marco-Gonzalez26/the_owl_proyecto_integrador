...
import { AlertTriangle, Eye, EyeOff, Mail, MapPin, Phone, Save, Shield, User, X } from 'lucide-react';
...
const breadcrumbs = [
    ...
    {
        title: 'Crear Usuario',
        href: '/the-owl/public/dashboard/users/create',
    },
];
                ...
                <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
                    ...
                    <div className="mb-8">
                        <div className="flex items-center justify-between">
                            <div>
                                <h1 className="text-3xl font-bold text-neutral-900">Crear Nuevo Usuario</h1>
                                <p className="mt-2 text-sm text-neutral-600">Agrega un nuevo usuario al sistema</p>
                            </div>
                            <Link
                                    ...
                                    {data.password && (
                                        <div className="rounded-lg border border-blue-200 bg-blue-50 p-4 md:col-span-2">
                                            ...
                                            <div className="space-y-1 text-sm">
                                                <div className={`flex items-center ${data.password.length >= 8 ? 'text-green-600' : 'text-red-600'}`}>
                                                ...
                                                <div className={`flex items-center ${/\d/.test(data.password) ? 'text-green-600' : 'text-red-600'}`}>
                        ...
                        {(data.nombre_completo || data.nombre_usuario || selectedRole) && (
                            <Card>
                                <CardHeader>
                                    ...
                                    <CardDescription>Así se verá el usuario en el sistema</CardDescription>
                                </CardHeader>
                                <CardContent>
