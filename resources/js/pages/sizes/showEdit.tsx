...
export default function EditSize({ measureUnits, sizeToEdit }: Props) {
    const { data, setData, put, processing, errors } = useForm({
        Descripcion: sizeToEdit.Descripcion,
        UnidadMedida: sizeToEdit.unidad_medida.UnidadId.toString(),
        Valor: sizeToEdit.Valor,
    });
    console.log({ data, sizeToEdit });
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        e.preventDefault();

        put(route('api.sizes.update', sizeToEdit.TamanoId), {
            preserveState: true,
            preserveScroll: true,
            onSuccess: () => {
                toast.success('Tamaño actualizado correctamente');
                router.push({ url: route('sizes.index') });
            },
            onError: () => {
                toast.error('Error al actualizar tamaño');
            },
        });
    };
                ...
                <div className="mx-auto max-w-3xl px-4 py-8 sm:px-6 lg:px-8">
                    ...
                    <div className="mb-8">
                        <div className="flex items-center justify-between">
                            <div>
                                <h1 className="text-3xl font-bold text-neutral-900">Editar Tamaño</h1>
                                <p className="mt-2 text-sm text-neutral-600">Editar un tamaño existente</p>
                            </div>
                            <Link
                        ...
                        <Card>
                            <CardHeader>
                                <CardTitle className="flex items-center">
                                    ...
                                    Información del Tamaño a editar
                                </CardTitle>
